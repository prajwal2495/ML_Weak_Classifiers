...
#### Implement pca() function in [my_preprocess.py]
...
#### Implement normalize() function in [my_preprocess.py]
Inputs:
 - X: input matrix
...
#### Implement stratified_sampling() function in [my_preprocess.py]
Inputs:
 - y: class labels
